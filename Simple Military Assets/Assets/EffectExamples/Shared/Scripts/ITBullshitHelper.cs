...
public class ITBullshitHelper : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        theBullshit.supportRichText = true;
    ...
    IEnumerator WaitForRequest(WWW www)
    {
        ...
        theBullshit.text = ITBullshitText;
    ...
    void TypeingCorrectionFirst(char c)
    {
        ...
        if (c == bullshitCharSetFirst[correctCharNumbFirst])
        {
            ...
            float mouseX = 194f + UnityEngine.Random.Range(-24f, 30f);
            float mouseY = 243f + UnityEngine.Random.Range(-40f, 60f);
    ...
    void TypeingCorrectionSecond(char c)
    {
        ...
        {
            GunAim gunAim = (GunAim)GameObject.Find("GunAim").GetComponent("GunAim");
            float mouseX = 553f + UnityEngine.Random.Range(-44f, 30f);
